...
wikisource = """Quando os [[w:direito autoral|Direitos de autor]] de uma obra expiram, ela entra em '''[[w:domínio público|domínio público]]'''.
Em Portugal, uma obra entra em [[w:domínio público|domínio público]] 70 anos após a morte do autor.<ref>{{citar web|url=temp |título=CÓDIGO DO DIREITO DE AUTOR E DOS DIREITOS CONEXOS| acessodata=2018-12-29}}</ref>
Segue-se uma '''lista de autores Portugueses cujas obras entram em domínio público em """ + str(pd_year_today) + """'''.
{| class="wikitable sortable" border="1" style="border-spacing:0; style="width:100%;"
! Nome
! Data de Nascimento
